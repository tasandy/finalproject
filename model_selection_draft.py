...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.2, random_state = 2) #if I want to keep my splitting constant. I can have 'random_state=1'
...
#compare actual response values with predicted for logistic
...
#find the best value k by iterating its value
k_range = range(1,25)
scores = []
for k in k_range:
